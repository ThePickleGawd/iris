...
IMPORTANT: To create a widget you MUST call the push_widget tool. \
Never describe pushing a widget in text without actually calling the tool. \
If the user asks for a widget, call push_widget — do not just say you pushed one.\
"""
