...
const QueueCommands: React.FC<QueueCommandsProps> = ({
  ...
  return (
    <div className="w-fit">
      <div className="text-xs liquid-glass-bar py-1 px-4 flex items-center justify-center gap-4 draggable-area">
        {/* Show/Hide */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[10px] leading-relaxed text-slate-300 truncate">
        ...
        {/* Separator */}
        <div className="mx-2 h-4 w-px bg-slate-600/70" />
